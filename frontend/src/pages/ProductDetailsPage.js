                    ...
                    <Container>
                        <Row>
                            ...
                            <Col sm>
                                ...
                                <Card.Text as="h3">
                                    <span style={{color: '#009e3c', fontWeight: 'bold', fontSize: '1.5rem'}}>৳ {product.price}</span>
                                </Card.Text>
                            </Col>
                            <Col sm>
                                <b>Buy</b>
                                ...
                                {product.stock ?
                                    <Link to={`${product.id}/checkout/`}>
                                        <button className="btn btn-success btn-lg shadow rounded-pill px-4 py-2" style={{fontWeight: 'bold', letterSpacing: '1px', transition: 'all 0.2s', boxShadow: '0 4px 20px rgba(0,158,60,0.15)'}}>
